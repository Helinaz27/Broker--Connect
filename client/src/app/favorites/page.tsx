          ...
          <div className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div className="space-y-2">
              <div className="flex items-center gap-3 text-primary">
                ...
                <span className="text-[10px] font-black uppercase tracking-[0.3em]">Personal Vault</span>
              </div>
              <h1 className="text-4xl font-black text-foreground tracking-tight italic">
                Saved Selections.
              </h1>
              <p className="text-muted-foreground font-medium">Curated listings and services you've bookmarked for later.</p>
            </div>
            <Link href="/">
              <Button variant="outline" className="rounded-xl border-border/60 font-bold text-xs h-11 px-6 hover:bg-muted/50 transition-all">
                Continue Browsing
              </Button>
            </Link>
          </div>
          ...
          {favorites.length > 0 ? (
            ...
            <div className="text-center py-24 bg-card/50 backdrop-blur-xl border border-border/50 rounded-[3rem] shadow-2xl shadow-black/[0.02] max-w-3xl mx-auto overflow-hidden relative">
              ...
              <div className="relative z-10">
                ...
                <h2 className="text-3xl font-black text-foreground tracking-tight mb-4 italic">Empty Vault.</h2>
                <p className="text-muted-foreground mb-10 max-w-md mx-auto font-medium">
                  Your favorites list is empty. Start exploring the marketplace to save properties, vehicles, and services you like.
                </p>
                <Link href="/">
                  <Button size="lg" className="h-14 px-10 rounded-2xl text-base font-black shadow-[0_20px_40px_-10px_rgba(59,130,246,0.3)] hover:shadow-[0_25px_50px_-12px_rgba(59,130,246,0.4)] transition-all duration-300">
                    Explore Marketplace
                  </Button>
                </Link>
              </div>
