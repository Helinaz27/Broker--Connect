          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-16 space-y-4">
                ...
                <p className="text-lg text-muted-foreground font-medium max-w-2xl mx-auto">
                  Have questions about our platform or need assistance with a
                  listing? Our team is here to help you.
                </p>
              </div>
                ...
                {[
                  {
                    icon: Mail,
                    label: "Email",
                    value: "support@brokerconnect.et",
                  ...
                  <div
                    key={i}
                    className="flex flex-col items-center p-8 rounded-3xl border border-border bg-card shadow-soft text-center"
                  >
                    <div
                      className={`h-12 w-12 rounded-2xl ${item.color} flex items-center justify-center mb-6`}
                    >
                      <item.icon className="h-6 w-6" />
                    </div>
