...
export default function Index() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      {/* Hero Section */}
      <section
        className="relative bg-background pt-14 pb-20 md:pt-20 md:pb-28"
        id="hero"
      >
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="flex flex-col gap-6 max-w-xl">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                List and discover properties, vehicles, and professional
                services in Addis Ababa with a secure, professional marketplace.
              </p>
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground max-w-md text-sm">
                Homes and apartments for rent or sale in Addis Ababa.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground max-w-md text-sm">
                Cars and SUVs for rent or hire.
              </p>
            </div>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="bg-primary rounded-xl p-10 md:p-14 text-center">
            ...
            <p className="text-primary-foreground/90 mt-3 max-w-xl mx-auto text-sm md:text-base">
              Join thousands of users. Create an account and start listing in
              minutes.
            </p>
            <div className="flex flex-wrap justify-center gap-3 mt-8">
              ...
              <Button
                size="lg"
                variant="outline"
                className="font-medium border-white/30 text-primary-foreground hover:bg-white/10"
                asChild
              >
