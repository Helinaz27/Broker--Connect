      ...
      <main className="flex-1 container px-6 py-12 md:py-20 max-w-4xl mx-auto animate-fade-in">
        ...
        <div className="space-y-4 mb-16">
          ...
          <p className="text-lg text-muted-foreground font-medium max-w-2xl">
            Find answers about using Digital Broker to list or discover houses,
            cars, and professional services in Ethiopia.
          </p>
        </div>
        ...
        <div className="mt-24 p-10 rounded-[2.5rem] bg-card border border-border shadow-glass text-center space-y-6">
          ...
          <p className="text-muted-foreground font-medium max-w-md mx-auto">
            Our support team is ready to help you with any platform inquiries or
            listing assistance.
          </p>
