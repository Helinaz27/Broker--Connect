    ...
    items: [
      {
        ...
        a: "Click “Sign in” in the header, then “Create account.” Enter your email, choose a password, and confirm. You can then sign in and start browsing or posting listings.",
      },
      {
        q: "What can I list on Digital Broker?",
        a: "You can list properties (for rent or sale), vehicles (for rent or hire), and professional services (plumber, electrician, catering). All listings are for the Ethiopian market, with locations such as Addis Ababa and other cities.",
      },
    ],
  },
  {
    ...
    items: [
      {
        q: "How do I post a property, car, or service?",
        a: "Sign in and go to your Dashboard. Use the sidebar to choose Properties, Vehicles, or Services, then “Create Listing.” Fill in the title, description, price, location, and any category-specific details. Add photos and submit.",
      },
      {
        q: "How do I edit or remove a listing?",
        a: "In the Dashboard, open the relevant section (e.g. “Manage All” under Properties). Use the edit or delete actions next to each listing to update or remove it.",
      },
      {
        q: "What should I include in a good listing?",
        a: "Use a clear title, an accurate price in Birr, and a specific location (e.g. Addis Ababa, Bole). Add a detailed description and several photos. For vehicles, include make, model, and year; for services, include your experience and what you offer.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        a: "Use the search bar on the home page or the filters (location, price range, and type: properties, vehicles, or services). You can also browse by category from the main navigation.",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Payments for rentals, vehicle hire, or services are agreed and made between users. Digital Broker does not process these payments unless we explicitly offer a payment feature. Always agree on payment method and terms before committing.",
      },
      {
    ...
    <div className="flex flex-col min-h-screen bg-background">
      <main className="flex-1 container px-4 py-12 md:py-16 max-w-3xl">
        ...
        <p className="text-muted-foreground mb-10">
          Find answers about using Digital Broker to list or find properties,
          vehicles, and services in Ethiopia.
        </p>
