  ...
  const stats = [
    {
      ...
      icon: Home,
      trend: t("dashboard.totalCount", { n: myListings.length }),
    ...
    },
    {
      ...
      icon: BarChart3,
      trend: t("dashboard.listed"),
      color: "bg-blue-500/10 text-blue-600",
    },
    {
      label: t("dashboard.carsAndServices"),
      value: String(
        myListings.filter(
  ...
  return (
    <div className="space-y-10 animate-in">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        >
          <PlusCircle className="h-4 w-4" /> {t("dashboard.newAssetPost")}
        </Button>
      </div>
