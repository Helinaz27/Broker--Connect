// client/src/components/houseListings/HouseListings.tsx
"use client";
...
export default function HouseListings({ queryParams }: HouseListingsProps) {
  ...
  const handleView = (id: string) => router.push(`/house-listings/${id}`);
  ...
  if (isError) {
    return (
      <div className="flex flex-col items-center gap-3 py-16 text-sm text-muted-foreground">
        <p>Failed to load house listings.</p>
        <button
          onClick={refetch}
