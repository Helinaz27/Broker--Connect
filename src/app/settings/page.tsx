    ...
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <main className="flex-1 container px-4 py-12 max-w-2xl">
        ...
        <div className="space-y-4">
          <Link href="/profile" className="flex items-center gap-4 p-4 rounded-lg border border-border bg-card hover:bg-muted/50 transition-colors">
          ...
          <div className="flex items-center gap-4 p-4 rounded-lg border border-border bg-card opacity-90">
            ...
            <Link href="/privacy"><Button variant="ghost" size="sm">View policy</Button></Link>
          </div>
        </div>
      </main>
      <Footer />
