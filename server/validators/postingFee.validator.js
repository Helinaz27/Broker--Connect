...
export const createPostingFeeValidator = [
  body('category')
    ...
    .isIn(['house', 'car', 'othersservice'])
    .withMessage('Category must be house, car, or othersservice'),
...
export const getAllPostingFeesValidator = [
  query('page')
    .optional()
...
export const updatePostingFeeValidator = [
  param('id')
    .notEmpty().withMessage('Posting fee ID is required')
    .isMongoId().withMessage('Invalid posting fee ID format'),
