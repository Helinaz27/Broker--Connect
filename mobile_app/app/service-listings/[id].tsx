...
export default function ServiceDetailScreen() {
  ...
  const serviceIcon =
    SERVICE_TYPE_ICONS[listing?.serviceType ?? "other"] ?? "construct-outline";
  ...
  if (isError || !listing)
    return (
      <View style={s.center}>
        ...
        <Text style={s.errorText}>Service not found</Text>
          ...
          >
            {images.length > 0 ? (
              ...
              <View style={[s.imagePlaceholder, { width }]}>
                <Ionicons name={serviceIcon as any} size={60} color="#fff" />
              </View>
            )}
          </ScrollView>
          {images.length > 1 && (
          ...
          <View style={s.imageBadges}>
            <View style={s.typeBadge}>
              ...
              <Text style={s.typeBadgeText}>
                {(listing.serviceType ?? "Service").replace(/_/g, " ")}
              </Text>
            </View>
          </View>
        </View>
        ...
        <View style={s.body}>
          ...
          <View style={s.titleRow}>
            ...
            <View style={s.priceWrap}>
              ...
              <Text style={s.priceSub}>ETB</Text>
            </View>
          </View>
          ...
          <View style={s.statsRow}>
            {listing.serviceType && (
              <StatPill
                icon={serviceIcon}
                value={listing.serviceType.replace(/_/g, " ")}
                t={t}
              />
            )}
            {loc.city && (
              <StatPill icon="location-outline" value={loc.city} t={t} />
            )}
          </View>
          ...
          {/* Description */}
          {listing.description && (
            <Section title="About this Service" t={t}>
              <Text style={s.desc}>{listing.description}</Text>
            </Section>
          )}

          {/* Service Details */}
          <Section title="Service Details" t={t}>
            <View style={s.detailsGrid}>
              ...
              {listing.price && (
                <DetailRow
                  label="Price"
                  value={`${listing.price.toLocaleString()} ETB`}
                  t={t}
                />
              )}
          ...
          {/* Contact section */}
          {!isOwner && (
            <Section title="Contact Provider" t={t}>
              {alreadyUnlocked && unlockedAccess ? (
                ...
                <View style={s.lockCard}>
                  ...
                  <Text style={s.lockSub}>
                    Unlock to see the provider's phone & email
                  </Text>
                  <View
                    style={[
                      s.coinCostBox,
              ...
              {chatting ? (
                ...
                <>
                  <Ionicons
                    ...
                    color={t.primary}
                  />
                  <Text style={s.chatBtnText}>Chat with Provider</Text>
                </>
              )}
            </TouchableOpacity>
          )}
